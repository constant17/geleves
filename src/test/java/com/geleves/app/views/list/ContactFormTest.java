...
public class ContactFormTest {
    ...
    public void setupData() {
        ...
        marcUsher.setPrenom("Marc");
        marcUsher.setNom("Usher");
    ...
    public void formFieldsPopulated() {
        ...
        Assert.assertEquals("Marc", form.prenom.getValue());
        Assert.assertEquals("Usher", form.nom.getValue());
    ...
    public void saveEventHasCorrectValues() {
        ...
        form.prenom.setValue("John");
        form.nom.setValue("Doe");
        ...
        Assert.assertEquals("John", savedContact.getPrenom());
        Assert.assertEquals("Doe", savedContact.getNom());
